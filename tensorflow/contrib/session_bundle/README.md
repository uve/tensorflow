...
[SavedModel](https://github.com/uve/tensorflow/blob/master/tensorflow/python/saved_model/README.md)
immediately.
...
*   `export.meta` -- MetaGraph Definition
    *   Binary [`tensorflow::MetaGraphDef`](https://github.com/uve/tensorflow/tree/master/tensorflow/core/protobuf/meta_graph.proto)
*   `export-?????-of-?????`
    *   A checkpoint of the Graph Variables
    *   Outputs from Python [`Saver`](https://github.com/uve/tensorflow/tree/master/tensorflow/python/training/saver.py)
        with `sharded=True`.

## Exporting (Python code)

The [`Exporter`](https://github.com/uve/tensorflow/tree/master/tensorflow/contrib/session_bundle/exporter.py)
...
TF.learn uses an
[Exporter wrapper](https://github.com/uve/tensorflow/blob/master/tensorflow/contrib/learn/python/learn/utils/export.py)
that can be used for building signatures. Use the `BaseEstimator.export`
function to export your Estimator with a signature.

## Importing (C++ code)

The [`LoadSessionBundleFromPath`](https://github.com/uve/tensorflow/tree/master/tensorflow/contrib/session_bundle/session_bundle.h)
...
The [`Manifest`](https://github.com/uve/tensorflow/tree/master/tensorflow/contrib/session_bundle/manifest.proto)
...
To specify a Signature, use the [Exporter wrapper](https://github.com/uve/tensorflow/blob/master/tensorflow/contrib/learn/python/learn/utils/export.py)
...
These can be recovered at serving time using utilities in [`signature.h`](https://github.com/uve/tensorflow/tree/master/tensorflow/contrib/session_bundle/signature.h)
...
In [`signature.h`](https://github.com/uve/tensorflow/tree/master/tensorflow/contrib/session_bundle/signature.h)

...
1.  Create an instance of [TfLiteDelegate](https://github.com/uve/tensorflow/blob/master/tensorflow/lite/c/c_api_internal.h#L545), which is responsible for registering the kernel node and claiming the nodes that the delegate can execute

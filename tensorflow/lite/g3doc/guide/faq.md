...
Lite, please see
[GitHub issues](https://github.com/uve/tensorflow/issues/28485).

For conversion issues not related to missing operations or control flow ops,
search our
[GitHub issues](https://github.com/uve/tensorflow/issues?q=label%3Acomp%3Alite+)
or file a [new one](https://github.com/uve/tensorflow/issues).
...
[summarize_graph](https://github.com/uve/tensorflow/blob/master/tensorflow/tools/graph_transforms/README.md#inspecting-graphs)
tool.
...
[`import_pb_to_tensorboard.py`](https://github.com/uve/tensorflow/blob/master/tensorflow/python/tools/import_pb_to_tensorboard.py)
script like below:
...
GitHub [issue #21526](https://github.com/uve/tensorflow/issues/21526).
...
[Quantization-aware training](https://github.com/uve/tensorflow/tree/r1.13/tensorflow/contrib/quantize).
...
*   *Tweak the number of threads.* Many TensorFlow Lite operators support
    ...
    [C++ API](https://github.com/uve/tensorflow/blob/master/tensorflow/lite/interpreter.h#L345)
...
*   *(Advanced) Profile Model.* The Tensorflow Lite
    [benchmarking tool](https://github.com/uve/tensorflow/tree/master/tensorflow/lite/tools/benchmark)
